...
## 2. Старый проект по Uniswap V3 / hedge

В предыдущем проекте рассматривалась LP-стратегия с хеджем в логике Uniswap V3. Этот проект показал, что concentrated liquidity сильно зависит от выбора диапазона и правил ребалансировки.
